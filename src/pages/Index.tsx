...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white bg-opacity-50 dark:bg-background transition-colors duration-300 flex flex-col items-center justify-between p-4 relative">
