  ...
  return (
    <div className="flex items-center justify-center w-full mt-[80px]">
      <div className="flex-1 flex justify-end">
        <span className="text-foreground font-chelsea" style={{ fontSize: "3rem", display: "inline-block" }}>{moonDescription}</span>
      </div>
      ...
      <div className="flex-1 flex justify-start">
        <span className="text-foreground font-chelsea" style={{ fontSize: "3rem", display: "inline-block" }}>{format(date, "d MMMM yyyy", { locale: nl })}</span>
      </div>
    </div>
  );
};
